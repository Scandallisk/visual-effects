...
function StartAfterburnEffect()		
	this:PlayEffect("AfterburnEffect")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(.1), "AfterburnLoop")
end

RegisterEventHandler(EventType.Timer, "AfterburnLoop",
function()

	this:StopEffect("AfterburnEffect")
	this:PlayEffect("AfterburnEffect")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(30), "AfterburnLoop")

end)

StartAfterburnEffect()