...
function StartPrimedWater2()		
	this:PlayEffect("PrimedWater2")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(.1), "CirclingWaterEffectLoop2")
end

RegisterEventHandler(EventType.Timer, "CirclingWaterEffectLoop2",
function()

	this:StopEffect("PrimedWater2")
	this:PlayEffect("PrimedWater2")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(60), "CirclingWaterEffectLoop2")
