...
function StartBubbleEnergyEffect()		
	...
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(.1), "PurpleBubbleEffectLoop")
end

RegisterEventHandler(EventType.Timer, "PurpleBubbleEffectLoop",
function()

	this:StopEffect("BubbleEnergyEffect")
	this:PlayEffect("BubbleEnergyEffect")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(60), "PurpleBubbleEffectLoop")
