...
function StartRiverSplashEffect()
				
		this:PlayEffect("RiverSplashEffect")
		this:ScheduleTimerDelay(TimeSpan.FromMinutes(.1), "WaterSplashEffectLoop")
end

RegisterEventHandler(EventType.Timer, "WaterSplashEffectLoop",
	function()
	
		this:StopEffect("RiverSplashEffect")	
		this:PlayEffect("RiverSplashEffect")
		this:ScheduleTimerDelay(TimeSpan.FromMinutes(1), "WaterSplashEffectLoop")
	
    end)
    
    StartRiverSplashEffect()