...
function StartGreenPortalEffect()		
	this:PlayEffect("GreenPortalEffect")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(.1), "GreenPortalEffectLoop")
end

RegisterEventHandler(EventType.Timer, "GreenPortalEffectLoop",
function()

	this:StopEffect("GreenPortalEffect")
	this:PlayEffect("GreenPortalEffect")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(60), "GreenPortalEffectLoop")

end)

StartGreenPortalEffect()