...
function StartSlowEffect()		
	this:PlayEffect("SlowEffect",2)
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(.1), "PurpleHazeEffectLoop")
end

RegisterEventHandler(EventType.Timer, "PurpleHazeEffectLoop",
function()

	this:StopEffect("SlowEffect")
	this:PlayEffect("SlowEffect",35)
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(30), "PurpleHazeEffectLoop")
