...
function StartCastVoid()		
	this:PlayEffect("CastVoid")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(.1), "VoidcastingLoop")
end

RegisterEventHandler(EventType.Timer, "VoidcastingLoop",
function()

	this:StopEffect("CastVoid")
	this:PlayEffect("CastVoid")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(60), "VoidcastingLoop")
