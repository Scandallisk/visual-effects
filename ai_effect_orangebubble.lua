...
function StartBubbleEffect()		
	this:PlayEffect("BubbleEffect")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(.1), "GlowingOrangeBubbleEffectLoop")
end

RegisterEventHandler(EventType.Timer, "GlowingOrangeBubbleEffectLoop",
function()

	this:StopEffect("BubbleEffect")
	this:PlayEffect("BubbleEffect")
	this:ScheduleTimerDelay(TimeSpan.FromSeconds(30), "GlowingOrangeBubbleEffectLoop")
